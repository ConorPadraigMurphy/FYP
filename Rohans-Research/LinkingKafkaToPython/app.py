...
def upload_video():
    ...
    filepath = os.path.join(inputs_dir, f"{video_id}.mp4")  # or use the original file extension
    file.save(filepath)
...
# Kafka configuration
kafka_config = {
    'bootstrap.servers': 'localhost:9092'  # Adjust if your Kafka server is on a different host or port
}
